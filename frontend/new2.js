...
function undoRedoCanvas(trackObj) {
    ...
    if (track <= -1) {
        ...
        let image = new ImageData(undoRedoTracker[track].data, undoRedoTracker[track].width, undoRedoTracker[track].height)
        tool.putImageData(image, 0, 0);
